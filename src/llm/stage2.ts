// Stage 2: Cloudflare AI Llama 3.3 70B to generate comprehensive CLI documentation
...
export async function generateCliDocs(
  ...
  console.log(`[Stage 2] Generating CLI docs for ${repo.owner}/${repo.repo} using Llama 3.3 70B...`);
  ...
  // Truncate README if needed (70B has larger context but still limited)
  const truncatedReadme = readme.length > 12000 
